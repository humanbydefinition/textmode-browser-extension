...
Before participating, please read and follow [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md). For security issues,
...
| `npm run check`                 | Run the CI-equivalent verification pipeline.           |
...
| `npm run e2e`                   | Run Playwright E2E tests against the Chrome E2E build. |
...
Read [docs/adr](docs/adr) before making architecture changes. If a change alters a durable project decision,
add a new ADR instead of only changing code.
...
- [README.md](README.md) explains the project, setup, usage, and architecture.
- [SUPPORT.md](SUPPORT.md) explains where to ask questions and report issues.
- [GOVERNANCE.md](GOVERNANCE.md) explains the maintainer-led decision process.
- [SECURITY.md](SECURITY.md) explains private vulnerability reporting.
- [PRIVACY.md](PRIVACY.md) explains data handling and permissions.
